    ...
    models: [
      {
        id: "gpt-5.5",
        label: "GPT-5.5",
        description: "Current flagship when API access is available",
      },
    ...
    models: [
      {
        ...
        description: "Free fast agent option when available",
      },
    ...
    models: [
      {
        ...
        description: "Strong coding and operations agent",
      },
